...
The following wording changes apply to \wgxxi{N4981} and can also be viewed on
Github via a fork of the \emph{C++ Standard Draft Sources} repository
\href{https://github.com/cplusplus/draft/compare/805aac8...pkeir:draft:c5ec068}{here}.
