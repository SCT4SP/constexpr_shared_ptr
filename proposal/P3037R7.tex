...
\item R7 2025-05-01
  \begin{itemize}
  \item Updated discussion on implementation of smart pointer adaptors (Section \ref{sec:adapt})
  \item Removed \texttt{constexpr} specifier from wording of smart pointer adaptor conversion operators
  \end{itemize}
\item R6 2025-04-24
  \begin{itemize}
...
current version. We therefore do not propose adding the \texttt{constexpr}
specifier to the conversion operators of \texttt{std::out\_ptr} or
\texttt{std::inout\_ptr}.
