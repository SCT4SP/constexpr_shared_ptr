...
```
// [-\ref{pointer.traits},-]{+\refX{pointer.traits},+} pointer traits
// [-\ref{pointer.conversion},-]{+\refX{pointer.conversion},+} pointer conversion
// [-\ref{ptr.align},-]{+\refX{ptr.align},+} pointer alignment
// [-\ref{obj.lifetime},-]{+\refX{obj.lifetime},+} explicit lifetime management
// [-\ref{allocator.tag},-]{+\refX{allocator.tag},+} allocator argument tag
// [-\ref{allocator.uses},-]{+\refX{allocator.uses},+} \tcode{uses_allocator}
// [-\ref{allocator.uses.trait},-]{+\refX{allocator.uses.trait},+} \tcode{uses_allocator}
// [-\ref{allocator.uses.construction},-]{+\refX{allocator.uses.construction},+} uses-allocator construction
// [-\ref{allocator.traits},-]{+\refX{allocator.traits},+} allocator traits
// [-\ref{default.allocator},-]{+\refX{default.allocator},+} the default allocator
// [-\ref{specialized.addressof},-]{+\refX{specialized.addressof},+} addressof
// [-\ref{specialized.algorithms},-]{+\refX{specialized.algorithms},+} specialized algorithms
// [-\ref{special.mem.concepts},-]{+\refX{special.mem.concepts},+} special memory concepts
// [-\ref{specialized.construct},-]{+\refX{specialized.construct},+} \tcode{construct_at}
// [-\ref{specialized.destroy},-]{+\refX{specialized.destroy},+} \tcode{destroy}
// [-\ref{unique.ptr},-]{+\refX{unique.ptr},+} class template \tcode{unique_ptr}
...
// [-\ref{util.smartptr.weak.bad},-]{+\refX{util.smartptr.weak.bad},+} class \tcode{bad_weak_ptr}
// [-\ref{util.smartptr.shared},-]{+\refX{util.smartptr.shared},+} class template \tcode{shared_ptr}
// [-\ref{util.smartptr.shared.create},-]{+\refX{util.smartptr.shared.create},+} \tcode{shared_ptr} creation
...
// [-\ref{util.smartptr.shared.cmp},-]{+\refX{util.smartptr.shared.cmp},+} \tcode{shared_ptr} comparisons
...
// [-\ref{util.smartptr.shared.spec},-]{+\refX{util.smartptr.shared.spec},+} \tcode{shared_ptr} specialized algorithms
@[`constexpr`]{.add}@ void swap(shared_ptr<T>& a, shared_ptr<T>& b) noexcept;
// [-\ref{util.smartptr.shared.cast},-]{+\refX{util.smartptr.shared.cast},+} \tcode{shared_ptr} casts
...
// [-\ref{util.smartptr.getdeleter},-]{+\refX{util.smartptr.getdeleter},+} \tcode{shared_ptr} \tcode{get_deleter}
@[`constexpr`]{.add}@ D* get_deleter(const shared_ptr<T>& p) noexcept;
// [-\ref{util.smartptr.shared.io},-]{+\refX{util.smartptr.shared.io},+} \tcode{shared_ptr} I/O
// [-\ref{util.smartptr.weak},-]{+\refX{util.smartptr.weak},+} class template \tcode{weak_ptr}
// [-\ref{util.smartptr.weak.spec},-]{+\refX{util.smartptr.weak.spec},+} \tcode{weak_ptr} specialized algorithms
template<class T> @[`constexpr`]{.add}@ void swap(weak_ptr<T>& a, weak_ptr<T>& b) noexcept;
// [-\ref{util.smartptr.ownerless},-]{+\refX{util.smartptr.ownerless},+} class template \tcode{owner_less}
// [-\ref{util.smartptr.owner.hash},-]{+\refX{util.smartptr.owner.hash},+} struct \tcode{owner_hash}
// [-\ref{util.smartptr.owner.equal},-]{+\refX{util.smartptr.owner.equal},+} struct \tcode{owner_equal}
// [-\ref{util.smartptr.enab},-]{+\refX{util.smartptr.enab},+} class template \tcode{enable_shared_from_this}
// [-\ref{util.smartptr.hash},-]{+\refX{util.smartptr.hash},+} hash support
// [-\ref{util.smartptr.atomic},-]{+\refX{util.smartptr.atomic},+} atomic smart pointers
// [-\ref{out.ptr.t},-]{+\refX{out.ptr.t},+} class template \tcode{out_ptr_t}
// [-\ref{out.ptr},-]{+\refX{out.ptr},+} function template \tcode{out_ptr}
@[`constexpr`]{.add}@ auto out_ptr(Smart& s, Args&&... args);
// [-\ref{inout.ptr.t},-]{+\refX{inout.ptr.t},+} class template \tcode{inout_ptr_t}
// [-\ref{inout.ptr},-]{+\refX{inout.ptr},+} function template \tcode{inout_ptr}
@[`constexpr`]{.add}@ auto inout_ptr(Smart& s, Args&&... args);
// [-\ref{unique.ptr.single.ctor},-]{+\refX{unique.ptr.single.ctor},+} constructors
// [-\ref{unique.ptr.single.dtor},-]{+\refX{unique.ptr.single.dtor},+} destructor
// [-\ref{unique.ptr.single.asgn},-]{+\refX{unique.ptr.single.asgn},+} assignment
// [-\ref{unique.ptr.single.observers},-]{+\refX{unique.ptr.single.observers},+} observers
// [-\ref{unique.ptr.single.modifiers},-]{+\refX{unique.ptr.single.modifiers},+} modifiers
// [-\ref{unique.ptr.runtime.ctor},-]{+\refX{unique.ptr.runtime.ctor},+} constructors
// [-\ref{unique.ptr.runtime.observers},-]{+\refX{unique.ptr.runtime.observers},+} observers
// [-\ref{unique.ptr.runtime.modifiers},-]{+\refX{unique.ptr.runtime.modifiers},+} modifiers
@[`constexpr`]{.add}@ bool operator<(const unique_ptr<T1, D1>& x, const unique_ptr<T2, D2>& y);
@[`constexpr`]{.add}@ bool operator>(const unique_ptr<T1, D1>& x, const unique_ptr<T2, D2>& y);
@[`constexpr`]{.add}@ bool operator<=(const unique_ptr<T1, D1>& x, const unique_ptr<T2, D2>& y);
@[`constexpr`]{.add}@ bool operator>=(const unique_ptr<T1, D1>& x, const unique_ptr<T2, D2>& y);
@[`constexpr`]{.add}@ compare_three_way_result_t<typename unique_ptr<T1, D1>::pointer,
// [-\ref{util.smartptr.shared.const},-]{+\refX{util.smartptr.shared.const},+} constructors
...
// [-\ref{util.smartptr.shared.dest},-]{+\refX{util.smartptr.shared.dest},+} destructor
@[`constexpr`]{.add}@ ~shared_ptr();
// [-\ref{util.smartptr.shared.assign},-]{+\refX{util.smartptr.shared.assign},+} assignment
...
// [-\ref{util.smartptr.shared.mod},-]{+\refX{util.smartptr.shared.mod},+} modifiers
...
// [-\ref{util.smartptr.shared.obs},-]{+\refX{util.smartptr.shared.obs},+} observers
...
@[`constexpr`]{.add}@ shared_ptr<T> reinterpret_pointer_cast(shared_ptr<U>&& r) noexcept;
@[`constexpr`]{.add}@ D* get_deleter(const shared_ptr<T>& p) noexcept;
// [-\ref{util.smartptr.weak.const},-]{+\refX{util.smartptr.weak.const},+} constructors
...
// [-\ref{util.smartptr.weak.dest},-]{+\refX{util.smartptr.weak.dest},+} destructor
@[`constexpr`]{.add}@ ~weak_ptr();
// [-\ref{util.smartptr.weak.assign},-]{+\refX{util.smartptr.weak.assign},+} assignment
...
// [-\ref{util.smartptr.weak.mod},-]{+\refX{util.smartptr.weak.mod},+} modifiers
@[`constexpr`]{.add}@ void swap(weak_ptr& r) noexcept;
@[`constexpr`]{.add}@ void reset() noexcept;
// [-\ref{util.smartptr.weak.obs},-]{+\refX{util.smartptr.weak.obs},+} observers
@[`constexpr`]{.add}@ long use_count() const noexcept;
...
@[`constexpr`]{.add}@ operator void**() const noexcept;
@[`constexpr`]{.add}@ auto inout_ptr(Smart& s, Args&&... args);
// [-\ref{mem.res.class},-]{+\refX{mem.res.class},+} class \tcode{memory_resource}
// [-\ref{mem.poly.allocator.class},-]{+\refX{mem.poly.allocator.class},+} class template \tcode{polymorphic_allocator}
// [-\ref{mem.res.global},-]{+\refX{mem.res.global},+} global memory resources
// [-\ref{mem.res.pool},-]{+\refX{mem.res.pool},+} pool resource classes
// [-\ref{mem.poly.allocator.ctor},-]{+\refX{mem.poly.allocator.ctor},+} constructors
// [-\ref{mem.poly.allocator.mem},-]{+\refX{mem.poly.allocator.mem},+} member functions
// [-\ref{scoped.adaptor.operators},-]{+\refX{scoped.adaptor.operators},+} scoped allocator operators
```
